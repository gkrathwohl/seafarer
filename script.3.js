  ...
  new png.PNG({ filterType:4 }).parse( buffer, function(error, image){
    ...
    while(q.peekFront()){
      ...
      while(curr_pixel = current_generation.pop()) {
        ...
        // knights move
        neighbors.push([curr_pixel[0]+1, curr_pixel[1]+2])
        neighbors.push([curr_pixel[0]+2, curr_pixel[1]+1])
        neighbors.push([curr_pixel[0]+2, curr_pixel[1]-1])
        neighbors.push([curr_pixel[0]+1, curr_pixel[1]-2])
        neighbors.push([curr_pixel[0]-1, curr_pixel[1]-2])
        neighbors.push([curr_pixel[0]-2, curr_pixel[1]-1])
    ...
    while(!skip && !(current_pixel[0] == goal[0] && current_pixel[1] == goal[1])){
      neighbors = [
        ...
        [current_pixel[0]-1, current_pixel[1] + 1],
        // knights move
        [current_pixel[0]+1, current_pixel[1]+2],
        [current_pixel[0]+2, current_pixel[1]+1],
        [current_pixel[0]+2, current_pixel[1]-1],
        [current_pixel[0]+1, current_pixel[1]-2],
        [current_pixel[0]-1, current_pixel[1]-2],
        [current_pixel[0]-2, current_pixel[1]-1],
